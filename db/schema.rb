...
ActiveRecord::Schema.define(version: 2021_07_05_215109) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "applied_for_id"
    t.index ["applied_for_id"], name: "index_messages_on_applied_for_id"
  ...
  add_foreign_key "messages", "applied_fors"
