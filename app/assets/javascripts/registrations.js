...
function validateSubdomain(id) {
  return (
    validator.validate_presence(id) && validator.validate_subdomain_format(id)
  )
}
...
function validateEmail(id) {
  return validator.validate_presence(id) && validator.validate_email_format(id)
}

function validatePassword(id) {
  return validator.validate_presence(id) && validator.validate_min_length(id, 6)
}
